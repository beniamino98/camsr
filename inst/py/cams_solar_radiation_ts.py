# Request and download solar radiation daily data with CAMS api 
# API: cams-solar-radiation-timeseries
import cdsapi
...
# - start: start date in format "%Y-%m-%d" (default "2005-01-01")
# - end: end date in format "%Y-%m-%d" (default datetime.date.today())
# - altitude: reference altitude (optional) 
# - filename: output directory where the file will be saved.
#
#   Example
# 
